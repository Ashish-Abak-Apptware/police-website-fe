  ...
  return (
    ...
    <section className="flex justify-center mx-auto bg-white">
      ...
      <div className="bg-hero-section-bg bg-center text-Natural-Gray-100 p-6 rounded-2xl flex flex-col justify-center  xl:w-[327px] xl:h-[227px]">
        <h2 className="xl:text-xl text-lg mb-2">व्हॉट्सअ‍ॅपवरील एकूण संदेश</h2>
        <div className="xl:text-6xl text-4xl font-bold">2685</div>
      </div>

      {/* Important Messages */}
      <div className="bg-Primary-Blue-100 p-6 rounded-xl space-y-2 xl:w-[327px] xl:h-[316px]">
        <h2 className="xl:text-[20px] text-lg text-Natural-Gray-50 mb-10">महत्त्वाचे संदेश</h2>
        <div className="text-Primary-Blue-30 font-semibold xl:text-[24px] text-xl mb-4">वाहतूक <span className="float-right">648</span></div>
        <div className="text-Natural-Gray-50 xl:text-[20px] text-lg mb-4">गस्त <span className="float-right">23</span></div>
        <div className="text-Natural-Gray-50 xl:text-[20px] text-lg mb-4">महिला सुरक्षा <span className="float-right">89</span></div>
        <div className="text-Natural-Gray-50 xl:text-[20px] text-lg">अंमली पदार्थ <span className="float-right">11</span></div>
      </div>
    </div>
