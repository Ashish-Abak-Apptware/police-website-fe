        ...
        <section className="flex justify-center bg-Natural-Gray-100">
            <section className="xl:w-[1280px] xl:p-[100px] md:w-[768px] w-full px-4 py-[50px] flex flex-col gap-16">
                <div className="md:flex md:flex-row flex flex-col gap-8">
                    <Image src="/image/commissioner.png" alt="Commissioner" width={800} height={800} className="xl:w-[500px] xl:h-[400px] hidden md:block"/>
                    <div className="flex flex-col gap-4">
                        <h1 className="text-Natural-Gray-20 xl:text-4xl text-xl font-bold">पोलीस आयुक्तांचा संदेश</h1>
                        <Image src="/image/commissioner.png" alt="Commissioner" width={800} height={800} className="xl:w-[500px] xl:h-[400px] md:hidden block"/>
